        ...
        navbarColor: function () {
            ...
            $(window).on('scroll', function () {
                if ($(this).scrollTop() > 70) { // Set position from top to add class
                    ...
                    $('.yellow .navbar-brand> img').attr('src', 'assets/images/yellow-dark.png');
                    $('.green .navbar-brand> img').attr('src', 'assets/images/green-dark.png');
                    $('.blue .navbar-brand> img').attr('src', 'assets/images/blue-dark.png');
                    $('.red .navbar-brand> img').attr('src', 'assets/images/red-dark.png');
                    $('.orange .navbar-brand> img').attr('src', 'assets/img/logo.jpg');


                }
                else {
                    $('.navbar').removeClass("shrink");
                    $('.yellow .navbar-brand> img').attr('src', 'assets/images/yellow-white.png');
                    $('.green .navbar-brand> img').attr('src', 'assets/images/green-white.png');
                    $('.blue .navbar-brand> img').attr('src', 'assets/images/blue-white.png');
                    $('.red .navbar-brand> img').attr('src', 'assets/images/red-white.png');
                    $('.orange .navbar-brand> img').attr('src', 'assets/img/logo.jpg');
